...
class Cell2fate_DynamicalModelTimeAsParam_module(PyroModule):
    r"""
    ...
    def __init__(
        ...
        self.register_buffer("ones_c", torch.ones(self.n_obs,1,1))
    ...
    def forward(self, u_data, s_data, idx, batch_index):
        ...
        with obs_plate:
            t_c = pyro.param('t_c', init_tensor=self.ones_c*0.5, event_dim = 0)
