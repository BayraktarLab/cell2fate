...
from ._cell2fate_ModularTranscriptionRate_module_IndependentModules_LocalTime_SeperateTechnicalFactors import DifferentiationModel_ModularTranscriptionRate_IndependentModules_LocalTime_SeperateTechnicalFactors
from cell2fate.utils import multiplot_from_generator

class Cell2fate_ModularTranscriptionRate_IndependentModules_LocalTime(QuantileMixin, PyroSampleMixin, PyroSviTrainMixin, PltExportMixin, BaseModelClass):
    """
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        if model_class is None:
            model_class = DifferentiationModel_ModularTranscriptionRate_IndependentModules_LocalTime_SeperateTechnicalFactors
