...
class Cell2fate_DynamicalModel_PriorKnowledge_Sequential(QuantileMixin, PyroSampleMixin, PyroSviTrainMixin, PltExportMixin, BaseModelClass):
    """
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        if model_class is None:
            model_class = Cell2fate_DynamicalModel_PriorKnowledge_Sequential_module
    ...
    def train(
        ...
        **kwargs,
        ...
        if getattr(self.module.model, "discrete_variables", None) and (len(self.module.model.discrete_variables) > 0):
            kwargs["plan_kwargs"]["loss_fn"] = TraceEnum_ELBO(num_particles=1)
        else:
            kwargs["plan_kwargs"]["loss_fn"] = Trace_ELBO(num_particles=1)
