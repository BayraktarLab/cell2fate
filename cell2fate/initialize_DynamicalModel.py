...
def initialize_DynamicalModel(adata, NMF_posterior_means, cluster_order = None, 
    ...
    init_vals = {"gamma_g": torch.tensor(gamma_g).unsqueeze(0),
                 ...
                 "detection_y_c": torch.tensor(NMF_posterior_means["detection_y_c"]).unsqueeze(-1),
                 ...
                 "s_g_gene_add_mean" : torch.stack([torch.tensor(NMF_posterior_means["s_g_gene_add_mean"]),
                                                    us_ratio*torch.tensor(NMF_posterior_means["s_g_gene_add_mean"])], axis = -1),
