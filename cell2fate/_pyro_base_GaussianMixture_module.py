...
from pyro.infer.autoguide import AutoHierarchicalNormalMessenger, AutoLowRankMultivariateNormal, AutoNormal
from cell2location.models.base._pyro_mixin import AutoGuideMixinModule, init_to_value
from pyro.infer import config_enumerate

class GaussianMixtureBaseModule(PyroBaseModuleClass, AutoGuideMixinModule):
    def __init__(
        self,
        model,
