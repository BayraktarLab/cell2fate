...
from ._cell2fate_ModularTranscriptionRate_module_IndependentModules_LocalTime import DifferentiationModel_ModularTranscriptionRate_IndependentModules_LocalTime
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        if model_class is None:
            model_class = DifferentiationModel_ModularTranscriptionRate_IndependentModules_LocalTime
