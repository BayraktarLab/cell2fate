...
class Cell2fate_DynamicalModel_ModuleSpecificTime_module(PyroModule):
    r"""
    ...
    def forward(self, u_data, s_data, idx, batch_index):
        ...
        t_mON = pyro.sample('t_mON', dist.Normal(t_c_loc, t_c_scale).expand([1, 1, self.n_modules]).to_event(2))
