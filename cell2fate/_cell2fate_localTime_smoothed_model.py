...
class Cell2fate_LocalTime_SmoothedCounts(QuantileMixin, PyroSampleMixin, PyroSviTrainMixin, PltExportMixin, BaseModelClass):
    """
...
#             model_kwargs["init_vals"] = {"per_cluster_mu_fg": aver.values.T.astype("float32") + 0.0001}
    ...
    def setup_anndata(
        ...
        **kwargs,
        ...
        anndata_fields = [
            LayerField('unspliced', unspliced_label, is_count_data=False),
            LayerField('spliced', spliced_label, is_count_data=False),
    ...
    def export_posterior(
        ...
        self.samples['post_sample_means']['gamma_g'][...,0] * self.adata_manager.get_from_registry('spliced')
        ...
        if sample_kwargs['return_samples'] and full_velocity_posterior == True:
            ...
            self.adata_manager.get_from_registry('unspliced') - self.samples['posterior_samples']['gamma_g'][...,0] * \
