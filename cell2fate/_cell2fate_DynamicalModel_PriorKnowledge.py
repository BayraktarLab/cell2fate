...
from ._cell2fate_DynamicalModel_PriorKnowledge_module import \
Cell2fate_DynamicalModel_PriorKnowledge_module
...
class Cell2fate_DynamicalModel_PriorKnowledge(QuantileMixin, PyroSampleMixin, PyroSviTrainMixin, PltExportMixin, BaseModelClass):
    """
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        if model_class is None:
            model_class = Cell2fate_DynamicalModel_PriorKnowledge_module
