...
from ._cell2fate_DynamicalModel_ModuleSpecificTime_NonGaussianTimePrior_module import \
Cell2fate_DynamicalModel_ModuleSpecificTime_NonGaussianTimePrior_module
...
class Cell2fate_DynamicalModel_ModuleSpecificTime_NonGaussianTimePrior(QuantileMixin, PyroSampleMixin, PyroSviTrainMixin, PltExportMixin, BaseModelClass):
    """
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        if model_class is None:
            model_class = Cell2fate_DynamicalModel_ModuleSpecificTime_NonGaussianTimePrior_module
...
#         self.samples['post_sample_means']['mu_expression'][...,1]
    ...
    def compare_module_activation(self, adata, chosen_modules, time_max = None, time_min = 0,
        ...
        for m in chosen_modules:
            ...
            ax.scatter(self.samples['post_sample_means']['T_cm'][:,:,m].flatten() - np.min(self.samples['post_sample_means']['T_cm'][:,:,m].flatten()), abundance, s = 10, label = 'Module ' + str(m))
